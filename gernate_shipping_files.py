...
def main():
    ...
    merged_file = os.path.join(config.SHIPPING_DIR, f"{timestamp}_{config.SHIPPING_FILENAME}_raw.csv")
    ...
    verfied_file = os.path.join(config.SHIPPING_DIR, f"{timestamp}_{config.SHIPPING_FILENAME}_verified.csv")
